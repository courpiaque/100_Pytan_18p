...
namespace StoPyta_JedenOsiemL
{
    public class Questions
    {
        ...
        public Questions()
        {
            ...
            "Wymień swoją jedną seksualną fantazję, której nie zrealizowałeś",
            ...
            "W pierwsze kolejności lepiej zaspokoić, czy być zaspokojonym?",
            ...
            "Czy jesteś głośno podczas seksu, czy zupełnie nie?",
            ...
            "Gdybyś miał na zawsze zrezygnować z jednej sekssualnej pozycji to z jakiej?",
            ...
            "Czy masz dni, w które masz większą ochotę niż zwykle? Od czego to zależy?",
            "Ile czasu mógłbyś wytrzymać bez seksu?",
            "Jak często myślisz o seksie?",
            "Jak wyglądałby Twój wymarzony pokój zabaw?",
            "Co myślisz o seksie bez zabezpieczenia?",
            "Co lepsze? Długotrwały związek, czy szybka przygoda?",
            ...
            "Jakie jedzienie jest największym seksualnym afrodyzjakiem?",
